...
#define DEFAULT_MYSQL_HOME "/usr/local/Cellar/mysql-connector-c/6.1.11"
#define SHAREDIR "/usr/local/Cellar/mysql-connector-c/6.1.11/share"
#define DEFAULT_BASEDIR "/usr/local/Cellar/mysql-connector-c/6.1.11"
#define MYSQL_DATADIR "/usr/local/Cellar/mysql-connector-c/6.1.11/data"
#define MYSQL_KEYRINGDIR "/usr/local/Cellar/mysql-connector-c/6.1.11/keyring"
#define DEFAULT_CHARSET_HOME "/usr/local/Cellar/mysql-connector-c/6.1.11"
#define PLUGINDIR "/usr/local/Cellar/mysql-connector-c/6.1.11/lib/plugin"
#define DEFAULT_SYSCONFDIR "/usr/local/Cellar/mysql-connector-c/6.1.11/etc"
