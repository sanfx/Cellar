...
enum opt_code
{
  ...
  OPT_Wnonportable_cfstrings = 319,          /* -Wnonportable-cfstrings */
  ...
  OPT_Z = 471,                               /* -Z */
  OPT_Zall_load = 472,                       /* -Zall_load */
  OPT_Zallowable_client = 473,               /* -Zallowable_client */
  OPT_Zarch_errors_fatal = 474,              /* -Zarch_errors_fatal */
  OPT_Zbind_at_load = 475,                   /* -Zbind_at_load */
  OPT_Zbundle = 476,                         /* -Zbundle */
  OPT_Zbundle_loader = 477,                  /* -Zbundle_loader */
  OPT_Zdead_strip = 478,                     /* -Zdead_strip */
  OPT_Zdylib_file = 479,                     /* -Zdylib_file */
  OPT_Zdynamic = 480,                        /* -Zdynamic */
  OPT_Zdynamiclib = 481,                     /* -Zdynamiclib */
  OPT_Zexported_symbols_list = 482,          /* -Zexported_symbols_list */
  OPT_Zflat_namespace = 483,                 /* -Zflat_namespace */
  OPT_Zfn_seg_addr_table_filename = 484,     /* -Zfn_seg_addr_table_filename */
  OPT_Zforce_cpusubtype_ALL = 485,           /* -Zforce_cpusubtype_ALL */
  OPT_Zforce_flat_namespace = 486,           /* -Zforce_flat_namespace */
  OPT_Zimage_base = 487,                     /* -Zimage_base */
  OPT_Zinit = 488,                           /* -Zinit */
  OPT_Zinstall_name = 489,                   /* -Zinstall_name */
  OPT_Zmulti_module = 490,                   /* -Zmulti_module */
  OPT_Zmultiply_defined = 491,               /* -Zmultiply_defined */
  OPT_Zmultiplydefinedunused = 492,          /* -Zmultiplydefinedunused */
  OPT_Zno_dead_strip_inits_and_terms = 493,  /* -Zno_dead_strip_inits_and_terms */
  OPT_Zseg_addr_table = 494,                 /* -Zseg_addr_table */
  OPT_Zsegaddr = 495,                        /* -Zsegaddr */
  OPT_Zsegs_read_only_addr = 496,            /* -Zsegs_read_only_addr */
  OPT_Zsegs_read_write_addr = 497,           /* -Zsegs_read_write_addr */
  OPT_Zsingle_module = 498,                  /* -Zsingle_module */
  OPT_Zumbrella = 499,                       /* -Zumbrella */
  OPT_Zunexported_symbols_list = 500,        /* -Zunexported_symbols_list */
  OPT_Zweak_reference_mismatches = 501,      /* -Zweak_reference_mismatches */
  /* OPT_all_load = 502, */                  /* -all_load */
  /* OPT_allowable_client = 503, */          /* -allowable_client */
  OPT_ansi = 504,                            /* -ansi */
  OPT_arch = 505,                            /* -arch */
  /* OPT_arch_errors_fatal = 506, */         /* -arch_errors_fatal */
  OPT_asm_macosx_version_min_ = 507,         /* -asm_macosx_version_min= */
  OPT_aux_info = 508,                        /* -aux-info */
  /* OPT_aux_info_ = 509, */                 /* -aux-info= */
  OPT_auxbase = 510,                         /* -auxbase */
  OPT_auxbase_strip = 511,                   /* -auxbase-strip */
  /* OPT_bind_at_load = 512, */              /* -bind_at_load */
  /* OPT_bootclasspath = 513, */             /* -bootclasspath */
  /* OPT_bundle = 514, */                    /* -bundle */
  /* OPT_bundle_loader = 515, */             /* -bundle_loader */
  OPT_c = 516,                               /* -c */
  /* OPT_classpath = 517, */                 /* -classpath */
  OPT_client_name = 518,                     /* -client_name */
  OPT_compatibility_version = 519,           /* -compatibility_version */
  OPT_coverage = 520,                        /* -coverage */
  OPT_cpp = 521,                             /* -cpp */
  OPT_cpp_ = 522,                            /* -cpp= */
  OPT_current_version = 523,                 /* -current_version */
  OPT_d = 524,                               /* -d */
  /* OPT_dead_strip = 525, */                /* -dead_strip */
  /* OPT_dependency_file = 526, */           /* -dependency-file */
  OPT_dumpbase = 527,                        /* -dumpbase */
  OPT_dumpdir = 528,                         /* -dumpdir */
  OPT_dumpmachine = 529,                     /* -dumpmachine */
  OPT_dumpspecs = 530,                       /* -dumpspecs */
  OPT_dumpversion = 531,                     /* -dumpversion */
  /* OPT_dylib_file = 532, */                /* -dylib_file */
  OPT_dylinker = 533,                        /* -dylinker */
  OPT_dylinker_install_name = 534,           /* -dylinker_install_name */
  /* OPT_dynamic = 535, */                   /* -dynamic */
  /* OPT_dynamiclib = 536, */                /* -dynamiclib */
  OPT_e = 537,                               /* -e */
  /* OPT_encoding = 538, */                  /* -encoding */
  OPT_export_dynamic = 539,                  /* -export-dynamic */
  /* OPT_exported_symbols_list = 540, */     /* -exported_symbols_list */
  OPT_extdirs = 541,                         /* -extdirs */
  /* OPT_fCLASSPATH_ = 542, */               /* -fCLASSPATH= */
  OPT_fPIC = 543,                            /* -fPIC */
  OPT_fPIE = 544,                            /* -fPIE */
  OPT_fRTS_ = 545,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 546,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 547,                   /* -fabi-version= */
  OPT_faccess_control = 548,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 549,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 550,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 551,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 552,                  /* -falign-commons */
  OPT_falign_functions = 553,                /* -falign-functions */
  OPT_falign_functions_ = 554,               /* -falign-functions= */
  OPT_falign_jumps = 555,                    /* -falign-jumps */
  OPT_falign_jumps_ = 556,                   /* -falign-jumps= */
  OPT_falign_labels = 557,                   /* -falign-labels */
  OPT_falign_labels_ = 558,                  /* -falign-labels= */
  OPT_falign_loops = 559,                    /* -falign-loops */
  OPT_falign_loops_ = 560,                   /* -falign-loops= */
  OPT_fall_intrinsics = 561,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 562, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 563,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 564,/* -fallow-parameterless-variadic-functions */
  /* OPT_falt_external_templates = 565, */   /* -falt-external-templates */
  OPT_fapple_kext = 566,                     /* -fapple-kext */
  /* OPT_fargument_alias = 567, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 568, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 569, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 570, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 571,            /* -fasan-shadow-offset= */
  OPT_fasm = 572,                            /* -fasm */
  OPT_fassert = 573,                         /* -fassert */
  OPT_fassociative_math = 574,               /* -fassociative-math */
  OPT_fassume_compiled = 575,                /* -fassume-compiled */
  OPT_fassume_compiled_ = 576,               /* -fassume-compiled= */
  OPT_fasynchronous_unwind_tables = 577,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 578,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 579,                   /* -fauto-profile */
  OPT_fauto_profile_ = 580,                  /* -fauto-profile= */
  OPT_fautomatic = 581,                      /* -fautomatic */
  OPT_faux_classpath = 582,                  /* -faux-classpath */
  OPT_fbackslash = 583,                      /* -fbackslash */
  OPT_fbacktrace = 584,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 585,             /* -fblas-matmul-limit= */
  OPT_fbootclasspath_ = 586,                 /* -fbootclasspath= */
  OPT_fbootstrap_classes = 587,              /* -fbootstrap-classes */
  OPT_fbounds_check = 588,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 589,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 590,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 591,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 592,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 593,               /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 594,                /* -fbuilding-libgcc */
  OPT_fbuiltin = 595,                        /* -fbuiltin */
  OPT_fbuiltin_ = 596,                       /* -fbuiltin- */
  OPT_fbuiltin_printf = 597,                 /* -fbuiltin-printf */
  OPT_fcall_saved_ = 598,                    /* -fcall-saved- */
  OPT_fcall_used_ = 599,                     /* -fcall-used- */
  OPT_fcaller_saves = 600,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 601,       /* -fcanonical-system-headers */
  OPT_fcheck_array_temporaries = 602,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 603,                /* -fcheck-data-deps */
  OPT_fcheck_new = 604,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 605,           /* -fcheck-pointer-bounds */
  OPT_fcheck_references = 606,               /* -fcheck-references */
  OPT_fcheck_ = 607,                         /* -fcheck= */
  OPT_fchecking = 608,                       /* -fchecking */
  OPT_fchkp_check_incomplete_type = 609,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 610,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 611,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 612,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_instrument_calls = 613,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 614,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 615,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 616, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 617,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 618,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 619,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 620, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 621,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 622,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 623,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 624,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 625,/* -fchkp-zero-input-bounds-for-main */
  OPT_fcilkplus = 626,                       /* -fcilkplus */
  OPT_fclasspath_ = 627,                     /* -fclasspath= */
  OPT_fcoarray_ = 628,                       /* -fcoarray= */
  OPT_fcombine_stack_adjustments = 629,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 630,                         /* -fcommon */
  OPT_fcompare_debug = 631,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 632,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 633,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 634,                   /* -fcompare-elim */
  OPT_fcompile_resource_ = 635,              /* -fcompile-resource= */
  OPT_fconcepts = 636,                       /* -fconcepts */
  OPT_fcond_mismatch = 637,                  /* -fcond-mismatch */
  OPT_fconserve_space = 638,                 /* -fconserve-space */
  OPT_fconserve_stack = 639,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 640,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 641,               /* -fconstexpr-depth= */
  OPT_fconvert_ = 642,                       /* -fconvert= */
  OPT_fcprop_registers = 643,                /* -fcprop-registers */
  OPT_fcray_pointer = 644,                   /* -fcray-pointer */
  OPT_fcrossjumping = 645,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 646,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 647, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 648,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 649,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 650,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 651,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 652,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 653,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 654,                       /* -fdbg-cnt= */
  OPT_fdce = 655,                            /* -fdce */
  OPT_fdebug_cpp = 656,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 657,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 658,            /* -fdebug-types-section */
  OPT_fdec = 659,                            /* -fdec */
  OPT_fdec_structure = 660,                  /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 661,              /* -fdeclone-ctor-dtor */
  OPT_fdeduce_init_list = 662,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 663,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 664, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 665,              /* -fdefault-integer-8 */
  OPT_fdefault_real_8 = 666,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 667,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 668,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 669,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 670,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 671,                   /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 672,         /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 673,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 674, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 675,             /* -fdiagnostics-color= */
  OPT_fdiagnostics_show_caret = 676,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_location_ = 677,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 678,        /* -fdiagnostics-show-option */
  OPT_fdirectives_only = 679,                /* -fdirectives-only */
  OPT_fdisable_ = 680,                       /* -fdisable- */
  OPT_fdisable_assertions = 681,             /* -fdisable-assertions */
  OPT_fdisable_assertions_ = 682,            /* -fdisable-assertions= */
  OPT_fdollar_ok = 683,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 684,         /* -fdollars-in-identifiers */
  OPT_fdse = 685,                            /* -fdse */
  OPT_fdump_ = 686,                          /* -fdump- */
  OPT_fdump_ada_spec = 687,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 688,             /* -fdump-ada-spec-slim */
  /* OPT_fdump_core = 689, */                /* -fdump-core */
  OPT_fdump_final_insns = 690,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 691,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 692,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 693,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 694,                  /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 695,        /* -fdump-internal-locations */
  OPT_fdump_noaddr = 696,                    /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 697, */          /* -fdump-parse-tree */
  OPT_fdump_passes = 698,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 699,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 700,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 701,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 702,                 /* -fearly-inlining */
  OPT_felide_constructors = 703,             /* -felide-constructors */
  OPT_feliminate_dwarf2_dups = 704,          /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 705, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 706,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 707,        /* -femit-class-debug-always */
  OPT_femit_class_file = 708,                /* -femit-class-file */
  OPT_femit_class_files = 709,               /* -femit-class-files */
  OPT_femit_struct_debug_baseonly = 710,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 711,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 712,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 713,                        /* -fenable- */
  OPT_fenable_assertions = 714,              /* -fenable-assertions */
  OPT_fenable_assertions_ = 715,             /* -fenable-assertions= */
  OPT_fencoding_ = 716,                      /* -fencoding= */
  OPT_fenforce_eh_specs = 717,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 718, */           /* -fenum-int-equiv */
  OPT_fexceptions = 719,                     /* -fexceptions */
  OPT_fexcess_precision_ = 720,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 721,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 722,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 723,           /* -fext-numeric-literals */
  OPT_fextdirs_ = 724,                       /* -fextdirs= */
  OPT_fextended_identifiers = 725,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 726,                /* -fextern-tls-init */
  OPT_fexternal_blas = 727,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 728, */       /* -fexternal-templates */
  OPT_ff2c = 729,                            /* -ff2c */
  OPT_ffast_math = 730,                      /* -ffast-math */
  OPT_ffat_lto_objects = 731,                /* -ffat-lto-objects */
  OPT_ffilelist_file = 732,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 733,               /* -ffinite-math-only */
  OPT_ffixed_ = 734,                         /* -ffixed- */
  OPT_ffixed_form = 735,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 736,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 737,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 738,                    /* -ffloat-store */
  OPT_ffor_scope = 739,                      /* -ffor-scope */
  /* OPT_fforce_addr = 740, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 741,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 742,              /* -fforward-propagate */
  OPT_ffp_contract_ = 743,                   /* -ffp-contract= */
  OPT_ffpe_summary_ = 744,                   /* -ffpe-summary= */
  OPT_ffpe_trap_ = 745,                      /* -ffpe-trap= */
  OPT_ffree_form = 746,                      /* -ffree-form */
  OPT_ffree_line_length_ = 747,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 748,          /* -ffree-line-length-none */
  OPT_ffreestanding = 749,                   /* -ffreestanding */
  OPT_ffriend_injection = 750,               /* -ffriend-injection */
  OPT_ffrontend_optimize = 751,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 752,                   /* -ffunction-cse */
  OPT_ffunction_sections = 753,              /* -ffunction-sections */
  OPT_fgcse = 754,                           /* -fgcse */
  OPT_fgcse_after_reload = 755,              /* -fgcse-after-reload */
  OPT_fgcse_las = 756,                       /* -fgcse-las */
  OPT_fgcse_lm = 757,                        /* -fgcse-lm */
  OPT_fgcse_sm = 758,                        /* -fgcse-sm */
  OPT_fgnat_encodings_ = 759,                /* -fgnat-encodings= */
  OPT_fgnu_keywords = 760,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 761,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 762,                         /* -fgnu-tm */
  OPT_fgnu_unique = 763,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 764,                   /* -fgnu89-inline */
  OPT_fgo_check_divide_overflow = 765,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 766,           /* -fgo-check-divide-zero */
  OPT_fgo_dump_ = 767,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 768,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 769,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 770,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 771,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 772,                       /* -fgraphite */
  OPT_fgraphite_identity = 773,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 774,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 775, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 776, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 777,           /* -fhash-synchronization */
  /* OPT_fhelp = 778, */                     /* -fhelp */
  /* OPT_fhelp_ = 779, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 780,           /* -fhoist-adjacent-loads */
  /* OPT_fhonor_std = 781, */                /* -fhonor-std */
  OPT_fhosted = 782,                         /* -fhosted */
  /* OPT_fhuge_objects = 783, */             /* -fhuge-objects */
  OPT_fident = 784,                          /* -fident */
  OPT_fif_conversion = 785,                  /* -fif-conversion */
  OPT_fif_conversion2 = 786,                 /* -fif-conversion2 */
  OPT_filelist = 787,                        /* -filelist */
  OPT_fimplement_inlines = 788,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 789,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 790,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 791,             /* -fimplicit-templates */
  OPT_findirect_classes = 792,               /* -findirect-classes */
  OPT_findirect_dispatch = 793,              /* -findirect-dispatch */
  OPT_findirect_inlining = 794,              /* -findirect-inlining */
  OPT_findirect_virtual_calls = 795,         /* -findirect-virtual-calls */
  OPT_finhibit_size_directive = 796,         /* -finhibit-size-directive */
  OPT_finit_character_ = 797,                /* -finit-character= */
  OPT_finit_integer_ = 798,                  /* -finit-integer= */
  OPT_finit_local_zero = 799,                /* -finit-local-zero */
  OPT_finit_logical_ = 800,                  /* -finit-logical= */
  OPT_finit_real_ = 801,                     /* -finit-real= */
  OPT_finline = 802,                         /* -finline */
  OPT_finline_atomics = 803,                 /* -finline-atomics */
  OPT_finline_functions = 804,               /* -finline-functions */
  OPT_finline_functions_called_once = 805,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 806, */            /* -finline-limit- */
  OPT_finline_limit_ = 807,                  /* -finline-limit= */
  OPT_finline_matmul_limit_ = 808,           /* -finline-matmul-limit= */
  OPT_finline_small_functions = 809,         /* -finline-small-functions */
  OPT_finput_charset_ = 810,                 /* -finput-charset= */
  OPT_finstrument_functions = 811,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 812,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 813,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 814,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 815,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 816,        /* -fintrinsic-modules-path= */
  OPT_fipa_cp = 817,                         /* -fipa-cp */
  OPT_fipa_cp_alignment = 818,               /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 819,                   /* -fipa-cp-clone */
  OPT_fipa_icf = 820,                        /* -fipa-icf */
  OPT_fipa_icf_functions = 821,              /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 822,              /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 823, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 824,                    /* -fipa-profile */
  OPT_fipa_pta = 825,                        /* -fipa-pta */
  OPT_fipa_pure_const = 826,                 /* -fipa-pure-const */
  OPT_fipa_ra = 827,                         /* -fipa-ra */
  OPT_fipa_reference = 828,                  /* -fipa-reference */
  OPT_fipa_sra = 829,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 830, */         /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 831,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 832,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 833,              /* -fira-loop-pressure */
  OPT_fira_region_ = 834,                    /* -fira-region= */
  OPT_fira_share_save_slots = 835,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 836,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 837,                   /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 838,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 839,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 840,               /* -fivar-visibility= */
  OPT_fivopts = 841,                         /* -fivopts */
  OPT_fjni = 842,                            /* -fjni */
  OPT_fjump_tables = 843,                    /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 844,             /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 845,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 846,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 847,             /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 848,          /* -fkeep-static-functions */
  /* OPT_flabels_ok = 849, */                /* -flabels-ok */
  /* OPT_flat_namespace = 850, */            /* -flat_namespace */
  OPT_flax_vector_conversions = 851,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 852,             /* -fleading-underscore */
  OPT_flifetime_dse = 853,                   /* -flifetime-dse */
  OPT_flifetime_dse_ = 854,                  /* -flifetime-dse= */
  OPT_flinker_output_ = 855,                 /* -flinker-output= */
  OPT_flive_range_shrinkage = 856,           /* -flive-range-shrinkage */
  OPT_flocal_ivars = 857,                    /* -flocal-ivars */
  /* OPT_floop_block = 858, */               /* -floop-block */
  /* OPT_floop_flatten = 859, */             /* -floop-flatten */
  /* OPT_floop_interchange = 860, */         /* -floop-interchange */
  OPT_floop_nest_optimize = 861,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 862, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 863,           /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 864, */          /* -floop-strip-mine */
  /* OPT_floop_unroll_and_jam = 865, */      /* -floop-unroll-and-jam */
  OPT_flra_remat = 866,                      /* -flra-remat */
  OPT_flto = 867,                            /* -flto */
  OPT_flto_compression_level_ = 868,         /* -flto-compression-level= */
  OPT_flto_odr_type_merging = 869,           /* -flto-odr-type-merging */
  OPT_flto_partition_ = 870,                 /* -flto-partition= */
  OPT_flto_report = 871,                     /* -flto-report */
  OPT_flto_report_wpa = 872,                 /* -flto-report-wpa */
  OPT_flto_ = 873,                           /* -flto= */
  OPT_fltrans = 874,                         /* -fltrans */
  OPT_fltrans_output_list_ = 875,            /* -fltrans-output-list= */
  OPT_fmain_ = 876,                          /* -fmain= */
  ...
  OPT_fmodule_private = 889,                 /* -fmodule-private */
  OPT_fmodulo_sched = 890,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 891,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 892,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 893,                  /* -fms-extensions */
  /* OPT_fmudflap = 894, */                  /* -fmudflap */
  /* OPT_fmudflapir = 895, */                /* -fmudflapir */
  /* OPT_fmudflapth = 896, */                /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 897, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 898, */                  /* -fnew-abi */
  OPT_fnext_runtime = 899,                   /* -fnext-runtime */
  OPT_fnil_receivers = 900,                  /* -fnil-receivers */
  /* OPT_fno_vect_cost_model = 901, */       /* -fno-vect-cost-model */
  ...
  OPT_fopenacc = 917,                        /* -fopenacc */
  OPT_fopenacc_dim_ = 918,                   /* -fopenacc-dim= */
  OPT_fopenmp = 919,                         /* -fopenmp */
  OPT_fopenmp_simd = 920,                    /* -fopenmp-simd */
  OPT_foperator_names = 921,                 /* -foperator-names */
  OPT_fopt_info = 922,                       /* -fopt-info */
  OPT_fopt_info_ = 923,                      /* -fopt-info- */
  /* OPT_foptimize_register_move = 924, */   /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 925,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 926,/* -foptimize-static-class-initialization */
  OPT_foptimize_strlen = 927,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 928, */           /* -foptional-diags */
  /* OPT_force_cpusubtype_ALL = 929, */      /* -force_cpusubtype_ALL */
  /* OPT_force_flat_namespace = 930, */      /* -force_flat_namespace */
  OPT_foutput_class_dir_ = 931,              /* -foutput-class-dir= */
  OPT_fpack_derived = 932,                   /* -fpack-derived */
  OPT_fpack_struct = 933,                    /* -fpack-struct */
  OPT_fpack_struct_ = 934,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 935,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 936,              /* -fpcc-struct-return */
  OPT_fpch_deps = 937,                       /* -fpch-deps */
  OPT_fpch_preprocess = 938,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 939,                     /* -fpeel-loops */
  OPT_fpeephole = 940,                       /* -fpeephole */
  OPT_fpeephole2 = 941,                      /* -fpeephole2 */
  OPT_fpermissive = 942,                     /* -fpermissive */
  OPT_fpic = 943,                            /* -fpic */
  OPT_fpie = 944,                            /* -fpie */
  ...
  OPT_fpre_ipa_mem_report = 950,             /* -fpre-ipa-mem-report */
  ...
  OPT_freduced_reflection = 983,             /* -freduced-reflection */
  OPT_free = 984,                            /* -free */
  ...
  OPT_fsanitize_coverage_trace_pc = 1003,    /* -fsanitize-coverage=trace-pc */
  ...
  OPT_fsaw_java_file = 1009,                 /* -fsaw-java-file */
  ...
  OPT_fsource_filename_ = 1052,              /* -fsource-filename= */
  OPT_fsource_ = 1053,                       /* -fsource= */
  ...
  OPT_fstore_check = 1076,                   /* -fstore-check */
  ...
  OPT_fsync_libcalls = 1083,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1084,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1085,                      /* -ftabstop= */
  /* OPT_ftarget_help = 1086, */             /* -ftarget-help */
  OPT_ftarget_ = 1087,                       /* -ftarget= */
  OPT_ftemplate_backtrace_limit_ = 1088,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1089, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1090,               /* -ftemplate-depth= */
  OPT_fterminated_vtables = 1091,            /* -fterminated-vtables */
  OPT_ftest_coverage = 1092,                 /* -ftest-coverage */
  /* OPT_fthis_is_variable = 1093, */        /* -fthis-is-variable */
  OPT_fthread_jumps = 1094,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1095,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1096,                   /* -ftime-report */
  OPT_ftls_model_ = 1097,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1098,              /* -ftoplevel-reorder */
  OPT_ftracer = 1099,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1100,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1101,        /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 1102,                 /* -ftrapping-math */
  OPT_ftrapv = 1103,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1104,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1105,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1106,                      /* -ftree-ccp */
  OPT_ftree_ch = 1107,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1108, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1109,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1110,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1111, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1112,                   /* -ftree-cselim */
  OPT_ftree_dce = 1113,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1114,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1115,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1116,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1117,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1118, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1119,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1120,          /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 1121,   /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1122,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1123,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1124, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1125,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1126,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1127,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1128,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1129,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1130,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1131,                      /* -ftree-pre */
  OPT_ftree_pta = 1132,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1133,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1134, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1135,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1136,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1137,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1138,                     /* -ftree-slsr */
  OPT_ftree_sra = 1139,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1140, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1141, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1142,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1143,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1144,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1145, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1146,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1147, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1148,                      /* -ftree-vrp */
  OPT_funconstrained_commons = 1149,         /* -funconstrained-commons */
  OPT_funderscoring = 1150,                  /* -funderscoring */
  OPT_funit_at_a_time = 1151,                /* -funit-at-a-time */
  OPT_funroll_all_loops = 1152,              /* -funroll-all-loops */
  OPT_funroll_loops = 1153,                  /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 1154,     /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1155,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1156,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1157,                 /* -funsigned-char */
  OPT_funswitch_loops = 1158,                /* -funswitch-loops */
  OPT_funwind_tables = 1159,                 /* -funwind-tables */
  OPT_fuse_atomic_builtins = 1160,           /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 1161,                  /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 1162,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1163,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 1164,         /* -fuse-divide-subroutine */
  OPT_fuse_ld_bfd = 1165,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1166,                   /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 1167,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1168,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1169,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1170,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1171,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1172,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1173, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1174,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1175,                   /* -fverbose-asm */
  /* OPT_fversion = 1176, */                 /* -fversion */
  OPT_fvisibility_inlines_hidden = 1177,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1178,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1179,                   /* -fvisibility= */
  OPT_fvpt = 1180,                           /* -fvpt */
  /* OPT_fvtable_gc = 1181, */               /* -fvtable-gc */
  /* OPT_fvtable_thunks = 1182, */           /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1183,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1184,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1185,                     /* -fvtv-debug */
  OPT_fweak = 1186,                          /* -fweak */
  OPT_fweb = 1187,                           /* -fweb */
  /* OPT_fwhole_file = 1188, */              /* -fwhole-file */
  OPT_fwhole_program = 1189,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1190,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1191,             /* -fworking-directory */
  OPT_fwpa = 1192,                           /* -fwpa */
  OPT_fwpa_ = 1193,                          /* -fwpa= */
  OPT_fwrapv = 1194,                         /* -fwrapv */
  /* OPT_fxref = 1195, */                    /* -fxref */
  /* OPT_fzee = 1196, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1197,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1198,                     /* -fzero-link */
  OPT_g = 1199,                              /* -g */
  OPT_gant = 1200,                           /* -gant */
  OPT_gcoff = 1201,                          /* -gcoff */
  OPT_gdwarf = 1202,                         /* -gdwarf */
  OPT_gdwarf_ = 1203,                        /* -gdwarf- */
  OPT_gen_decls = 1204,                      /* -gen-decls */
  OPT_gfull = 1205,                          /* -gfull */
  OPT_ggdb = 1206,                           /* -ggdb */
  OPT_ggnu_pubnames = 1207,                  /* -ggnu-pubnames */
  OPT_gnat = 1208,                           /* -gnat */
  OPT_gnatO = 1209,                          /* -gnatO */
  OPT_gno_pubnames = 1210,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1211,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1212,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1213,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1214,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1215,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1216,                   /* -gsplit-dwarf */
  OPT_gstabs = 1217,                         /* -gstabs */
  OPT_gstabs_ = 1218,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1219,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1220,                        /* -gtoggle */
  OPT_gused = 1221,                          /* -gused */
  OPT_gvms = 1222,                           /* -gvms */
  OPT_gxcoff = 1223,                         /* -gxcoff */
  OPT_gxcoff_ = 1224,                        /* -gxcoff+ */
  OPT_gz = 1225,                             /* -gz */
  OPT_gz_ = 1226,                            /* -gz= */
  OPT_h = 1227,                              /* -h */
  OPT_headerpad_max_install_names = 1228,    /* -headerpad_max_install_names */
  OPT_idirafter = 1229,                      /* -idirafter */
  OPT_iframework = 1230,                     /* -iframework */
  OPT_imacros = 1231,                        /* -imacros */
  /* OPT_image_base = 1232, */               /* -image_base */
  OPT_imultiarch = 1233,                     /* -imultiarch */
  OPT_imultilib = 1234,                      /* -imultilib */
  OPT_include = 1235,                        /* -include */
  /* OPT_init = 1236, */                     /* -init */
  /* OPT_install_name = 1237, */             /* -install_name */
  OPT_iplugindir_ = 1238,                    /* -iplugindir= */
  OPT_iprefix = 1239,                        /* -iprefix */
  OPT_iquote = 1240,                         /* -iquote */
  OPT_isysroot = 1241,                       /* -isysroot */
  OPT_isystem = 1242,                        /* -isystem */
  OPT_iwithprefix = 1243,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1244,              /* -iwithprefixbefore */
  OPT_k8 = 1245,                             /* -k8 */
  OPT_keep_private_externs = 1246,           /* -keep_private_externs */
  OPT_l = 1247,                              /* -l */
  OPT_lang_asm = 1248,                       /* -lang-asm */
  OPT_m128bit_long_double = 1249,            /* -m128bit-long-double */
  OPT_m16 = 1250,                            /* -m16 */
  OPT_m32 = 1251,                            /* -m32 */
  OPT_m3dnow = 1252,                         /* -m3dnow */
  OPT_m3dnowa = 1253,                        /* -m3dnowa */
  OPT_m64 = 1254,                            /* -m64 */
  OPT_m80387 = 1255,                         /* -m80387 */
  OPT_m8bit_idiv = 1256,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1257,             /* -m96bit-long-double */
  OPT_mabi_ = 1258,                          /* -mabi= */
  OPT_mabm = 1259,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1260,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1261,                 /* -maddress-mode= */
  OPT_madx = 1262,                           /* -madx */
  OPT_maes = 1263,                           /* -maes */
  OPT_malign_data_ = 1264,                   /* -malign-data= */
  OPT_malign_double = 1265,                  /* -malign-double */
  OPT_malign_functions_ = 1266,              /* -malign-functions= */
  OPT_malign_jumps_ = 1267,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1268,                  /* -malign-loops= */
  OPT_malign_stringops = 1269,               /* -malign-stringops */
  OPT_march_ = 1270,                         /* -march= */
  OPT_masm_ = 1271,                          /* -masm= */
  OPT_matt_stubs = 1272,                     /* -matt-stubs */
  OPT_mavx = 1273,                           /* -mavx */
  OPT_mavx2 = 1274,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1275,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1276,  /* -mavx256-split-unaligned-store */
  OPT_mavx512bw = 1277,                      /* -mavx512bw */
  OPT_mavx512cd = 1278,                      /* -mavx512cd */
  OPT_mavx512dq = 1279,                      /* -mavx512dq */
  OPT_mavx512er = 1280,                      /* -mavx512er */
  OPT_mavx512f = 1281,                       /* -mavx512f */
  OPT_mavx512ifma = 1282,                    /* -mavx512ifma */
  OPT_mavx512pf = 1283,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1284,                    /* -mavx512vbmi */
  OPT_mavx512vl = 1285,                      /* -mavx512vl */
  OPT_mbmi = 1286,                           /* -mbmi */
  OPT_mbmi2 = 1287,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1288,                  /* -mbranch-cost= */
  OPT_mcld = 1289,                           /* -mcld */
  OPT_mclflushopt = 1290,                    /* -mclflushopt */
  OPT_mclwb = 1291,                          /* -mclwb */
  OPT_mclzero = 1292,                        /* -mclzero */
  OPT_mcmodel_ = 1293,                       /* -mcmodel= */
  OPT_mconstant_cfstrings = 1294,            /* -mconstant-cfstrings */
  /* OPT_mcpu_ = 1295, */                    /* -mcpu= */
  OPT_mcrc32 = 1296,                         /* -mcrc32 */
  OPT_mcx16 = 1297,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1298,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1299,            /* -mdump-tune-features */
  OPT_mdynamic_no_pic = 1300,                /* -mdynamic-no-pic */
  OPT_mf16c = 1301,                          /* -mf16c */
  OPT_mfancy_math_387 = 1302,                /* -mfancy-math-387 */
  OPT_mfentry = 1303,                        /* -mfentry */
  OPT_mfix_and_continue = 1304,              /* -mfix-and-continue */
  OPT_mfma = 1305,                           /* -mfma */
  OPT_mfma4 = 1306,                          /* -mfma4 */
  OPT_mforce_drap = 1307,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1308,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1309,                       /* -mfpmath= */
  OPT_mfsgsbase = 1310,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1311, */              /* -mfused-madd */
  OPT_mfxsr = 1312,                          /* -mfxsr */
  OPT_mhard_float = 1313,                    /* -mhard-float */
  OPT_mhle = 1314,                           /* -mhle */
  OPT_miamcu = 1315,                         /* -miamcu */
  OPT_mieee_fp = 1316,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1317,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1318,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1319,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1320, */            /* -mintel-syntax */
  OPT_mkernel = 1321,                        /* -mkernel */
  OPT_mlarge_data_threshold_ = 1322,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1323,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1324,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1325,                /* -mlong-double-80 */
  OPT_mlwp = 1326,                           /* -mlwp */
  OPT_mlzcnt = 1327,                         /* -mlzcnt */
  OPT_mmacosx_version_min_ = 1328,           /* -mmacosx-version-min= */
  OPT_mmemcpy_strategy_ = 1329,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1330,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1331,                  /* -mmitigate-rop */
  OPT_mmmx = 1332,                           /* -mmmx */
  OPT_mmovbe = 1333,                         /* -mmovbe */
  OPT_mmpx = 1334,                           /* -mmpx */
  OPT_mms_bitfields = 1335,                  /* -mms-bitfields */
  OPT_mmwaitx = 1336,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1337,            /* -mno-align-stringops */
  OPT_mno_default = 1338,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1339,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1340,                  /* -mno-push-args */
  OPT_mno_red_zone = 1341,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1342,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1343,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1344,       /* -momit-leaf-frame-pointer */
  OPT_mone_byte_bool = 1345,                 /* -mone-byte-bool */
  OPT_mpc32 = 1346,                          /* -mpc32 */
  OPT_mpc64 = 1347,                          /* -mpc64 */
  OPT_mpc80 = 1348,                          /* -mpc80 */
  OPT_mpclmul = 1349,                        /* -mpclmul */
  OPT_mpcommit = 1350,                       /* -mpcommit */
  OPT_mpku = 1351,                           /* -mpku */
  OPT_mpopcnt = 1352,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1353,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1354,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1355,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1356,                        /* -mprfchw */
  OPT_mpush_args = 1357,                     /* -mpush-args */
  OPT_mrdrnd = 1358,                         /* -mrdrnd */
  OPT_mrdseed = 1359,                        /* -mrdseed */
  OPT_mrecip = 1360,                         /* -mrecip */
  OPT_mrecip_ = 1361,                        /* -mrecip= */
  OPT_mrecord_mcount = 1362,                 /* -mrecord-mcount */
  OPT_mred_zone = 1363,                      /* -mred-zone */
  OPT_mregparm_ = 1364,                      /* -mregparm= */
  OPT_mrtd = 1365,                           /* -mrtd */
  OPT_mrtm = 1366,                           /* -mrtm */
  OPT_msahf = 1367,                          /* -msahf */
  OPT_msha = 1368,                           /* -msha */
  OPT_mskip_rax_setup = 1369,                /* -mskip-rax-setup */
  OPT_msoft_float = 1370,                    /* -msoft-float */
  OPT_msse = 1371,                           /* -msse */
  OPT_msse2 = 1372,                          /* -msse2 */
  OPT_msse2avx = 1373,                       /* -msse2avx */
  OPT_msse3 = 1374,                          /* -msse3 */
  OPT_msse4 = 1375,                          /* -msse4 */
  OPT_msse4_1 = 1376,                        /* -msse4.1 */
  OPT_msse4_2 = 1377,                        /* -msse4.2 */
  OPT_msse4a = 1378,                         /* -msse4a */
  /* OPT_msse5 = 1379, */                    /* -msse5 */
  OPT_msseregparm = 1380,                    /* -msseregparm */
  OPT_mssse3 = 1381,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1382,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1383,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1384,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1385,            /* -mstringop-strategy= */
  OPT_mstv = 1386,                           /* -mstv */
  OPT_mtarget_linker = 1387,                 /* -mtarget-linker */
  OPT_mtbm = 1388,                           /* -mtbm */
  OPT_mtls_dialect_ = 1389,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1390,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1391,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1392,                         /* -mtune= */
  /* OPT_multi_module = 1393, */             /* -multi_module */
  /* OPT_multiply_defined = 1394, */         /* -multiply_defined */
  /* OPT_multiply_defined_unused = 1395, */  /* -multiply_defined_unused */
  OPT_mveclibabi_ = 1396,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1397,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1398,                    /* -mvzeroupper */
  OPT_mx32 = 1399,                           /* -mx32 */
  OPT_mxop = 1400,                           /* -mxop */
  OPT_mxsave = 1401,                         /* -mxsave */
  OPT_mxsavec = 1402,                        /* -mxsavec */
  OPT_mxsaveopt = 1403,                      /* -mxsaveopt */
  OPT_mxsaves = 1404,                        /* -mxsaves */
  OPT_n = 1405,                              /* -n */
  OPT_no_canonical_prefixes = 1406,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1407,              /* -no-integrated-cpp */
  OPT_no_pie = 1408,                         /* -no-pie */
  /* OPT_no_dead_strip_inits_and_terms = 1409, *//* -no_dead_strip_inits_and_terms */
  OPT_nocpp = 1410,                          /* -nocpp */
  OPT_nodefaultlibs = 1411,                  /* -nodefaultlibs */
  OPT_nofixprebinding = 1412,                /* -nofixprebinding */
  OPT_nomultidefs = 1413,                    /* -nomultidefs */
  OPT_noprebind = 1414,                      /* -noprebind */
  OPT_noseglinkedit = 1415,                  /* -noseglinkedit */
  OPT_nostartfiles = 1416,                   /* -nostartfiles */
  OPT_nostdinc = 1417,                       /* -nostdinc */
  OPT_nostdinc__ = 1418,                     /* -nostdinc++ */
  OPT_nostdlib = 1419,                       /* -nostdlib */
  OPT_o = 1420,                              /* -o */
  OPT_object = 1421,                         /* -object */
  OPT_p = 1422,                              /* -p */
  OPT_pagezero_size = 1423,                  /* -pagezero_size */
  OPT_pass_exit_codes = 1424,                /* -pass-exit-codes */
  /* OPT_pedantic = 1425, */                 /* -pedantic */
  OPT_pedantic_errors = 1426,                /* -pedantic-errors */
  OPT_pg = 1427,                             /* -pg */
  OPT_pie = 1428,                            /* -pie */
  OPT_pipe = 1429,                           /* -pipe */
  OPT_prebind = 1430,                        /* -prebind */
  OPT_prebind_all_twolevel_modules = 1431,   /* -prebind_all_twolevel_modules */
  OPT_preload = 1432,                        /* -preload */
  OPT_print_file_name_ = 1433,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1434,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1435,          /* -print-multi-directory */
  OPT_print_multi_lib = 1436,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1437,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1438,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1439,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1440,               /* -print-prog-name= */
  OPT_print_search_dirs = 1441,              /* -print-search-dirs */
  OPT_print_sysroot = 1442,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1443,   /* -print-sysroot-headers-suffix */
  OPT_private_bundle = 1444,                 /* -private_bundle */
  OPT_pthread = 1445,                        /* -pthread */
  OPT_quiet = 1446,                          /* -quiet */
  OPT_r = 1447,                              /* -r */
  OPT_rdynamic = 1448,                       /* -rdynamic */
  OPT_read_only_relocs = 1449,               /* -read_only_relocs */
  OPT_remap = 1450,                          /* -remap */
  OPT_s = 1451,                              /* -s */
  OPT_s_bc_abi = 1452,                       /* -s-bc-abi */
  OPT_save_temps = 1453,                     /* -save-temps */
  OPT_save_temps_ = 1454,                    /* -save-temps= */
  OPT_sectalign = 1455,                      /* -sectalign */
  OPT_sectcreate = 1456,                     /* -sectcreate */
  OPT_sectobjectsymbols = 1457,              /* -sectobjectsymbols */
  OPT_sectorder = 1458,                      /* -sectorder */
  OPT_seg1addr = 1459,                       /* -seg1addr */
  /* OPT_seg_addr_table = 1460, */           /* -seg_addr_table */
  /* OPT_seg_addr_table_filename = 1461, */  /* -seg_addr_table_filename */
  /* OPT_segaddr = 1462, */                  /* -segaddr */
  OPT_segcreate = 1463,                      /* -segcreate */
  OPT_seglinkedit = 1464,                    /* -seglinkedit */
  OPT_segprot = 1465,                        /* -segprot */
  /* OPT_segs_read_only_addr = 1466, */      /* -segs_read_only_addr */
  /* OPT_segs_read_write_addr = 1467, */     /* -segs_read_write_addr */
  OPT_shared = 1468,                         /* -shared */
  OPT_shared_libgcc = 1469,                  /* -shared-libgcc */
  /* OPT_single_module = 1470, */            /* -single_module */
  /* OPT_specs = 1471, */                    /* -specs */
  OPT_specs_ = 1472,                         /* -specs= */
  OPT_static = 1473,                         /* -static */
  OPT_static_libasan = 1474,                 /* -static-libasan */
  OPT_static_libgcc = 1475,                  /* -static-libgcc */
  OPT_static_libgcj = 1476,                  /* -static-libgcj */
  OPT_static_libgfortran = 1477,             /* -static-libgfortran */
  OPT_static_libgo = 1478,                   /* -static-libgo */
  OPT_static_liblsan = 1479,                 /* -static-liblsan */
  OPT_static_libmpx = 1480,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1481,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1482,               /* -static-libstdc++ */
  OPT_static_libtsan = 1483,                 /* -static-libtsan */
  OPT_static_libubsan = 1484,                /* -static-libubsan */
  /* OPT_std_c__03 = 1485, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1486, */                /* -std=c++0x */
  OPT_std_c__11 = 1487,                      /* -std=c++11 */
  OPT_std_c__14 = 1488,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1489, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1490, */                /* -std=c++1y */
  OPT_std_c__1z = 1491,                      /* -std=c++1z */
  OPT_std_c__98 = 1492,                      /* -std=c++98 */
  OPT_std_c11 = 1493,                        /* -std=c11 */
  /* OPT_std_c1x = 1494, */                  /* -std=c1x */
  /* OPT_std_c89 = 1495, */                  /* -std=c89 */
  OPT_std_c90 = 1496,                        /* -std=c90 */
  OPT_std_c99 = 1497,                        /* -std=c99 */
  /* OPT_std_c9x = 1498, */                  /* -std=c9x */
  OPT_std_f2003 = 1499,                      /* -std=f2003 */
  OPT_std_f2008 = 1500,                      /* -std=f2008 */
  OPT_std_f2008ts = 1501,                    /* -std=f2008ts */
  OPT_std_f95 = 1502,                        /* -std=f95 */
  OPT_std_gnu = 1503,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1504, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1505, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1506,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1507,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1508, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1509, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1510,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1511,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1512,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1513, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1514, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1515,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1516,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1517, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1518, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1519,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1520, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1521, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1522, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1523,                     /* -std=legacy */
  OPT_sub_library = 1524,                    /* -sub_library */
  OPT_sub_umbrella = 1525,                   /* -sub_umbrella */
  OPT_symbolic = 1526,                       /* -symbolic */
  OPT_t = 1527,                              /* -t */
  OPT_time = 1528,                           /* -time */
  OPT_time_ = 1529,                          /* -time= */
  OPT_traditional = 1530,                    /* -traditional */
  OPT_traditional_cpp = 1531,                /* -traditional-cpp */
  OPT_trigraphs = 1532,                      /* -trigraphs */
  OPT_twolevel_namespace = 1533,             /* -twolevel_namespace */
  OPT_twolevel_namespace_hints = 1534,       /* -twolevel_namespace_hints */
  OPT_u = 1535,                              /* -u */
  /* OPT_umbrella = 1536, */                 /* -umbrella */
  OPT_undef = 1537,                          /* -undef */
  OPT_undefined = 1538,                      /* -undefined */
  /* OPT_unexported_symbols_list = 1539, */  /* -unexported_symbols_list */
  OPT_v = 1540,                              /* -v */
  OPT_version = 1541,                        /* -version */
  OPT_w = 1542,                              /* -w */
  /* OPT_weak_reference_mismatches = 1543, *//* -weak_reference_mismatches */
  OPT_whatsloaded = 1544,                    /* -whatsloaded */
  OPT_whyload = 1545,                        /* -whyload */
  OPT_wrapper = 1546,                        /* -wrapper */
  OPT_x = 1547,                              /* -x */
  OPT_y = 1548,                              /* -y */
  OPT_z = 1549,                              /* -z */
  N_OPTS,
