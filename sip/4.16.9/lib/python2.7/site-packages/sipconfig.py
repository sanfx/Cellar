...
_pkg_config = {
    ...
    'py_version':         0x020705,
    'qt_framework':       0,
    'sip_bin':            '/usr/local/Cellar/sip/4.16.9/bin/sip',
    'sip_config_args':    '--deployment-target=10.9 --destdir=/usr/local/Cellar/sip/4.16.9/lib/python2.7/site-packages --bindir=/usr/local/Cellar/sip/4.16.9/bin --incdir=/usr/local/Cellar/sip/4.16.9/include --sipdir=/usr/local/share/sip',
    'sip_inc_dir':        '/usr/local/Cellar/sip/4.16.9/include',
    'sip_mod_dir':        '/usr/local/Cellar/sip/4.16.9/lib/python2.7/site-packages',
